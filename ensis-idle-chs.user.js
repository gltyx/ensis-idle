...
var cnItems = {
    ...
    "Locked": "未解锁",
    "... okay.": "... 好吧.",
    "Upgrades & Training": "升级 & 训练",
    "Current Body": "当前主体",
    "Current Obliteration": "当前湮灭",
    ". Added to your collection.": "。已添加至您的收藏。",
    "A careful investigate of the location.": "对该地点进行了仔细的勘查。",
    "A careful scour of the vicinity.": "对周边区域进行了仔细的搜查。",
    "As you scour the surroundings, you come across": "当您仔细搜查周围环境时，您发现了",
    "from the vicinity.": "来自周边区域的东西。",
    "Looking around the surroundings to scavenge, you manage to uncover": "环顾周围环境进行搜寻，您最终发现了",
    "Making sure to carefully scour the surroundings. Your efforts pay off as you discover": "确保仔细搜查周围环境。您的努力得到了回报，因为您发现了",
    "Started playing": "开始玩",
    "Taking time to scout the area, you stumble upon": "花时间侦察该区域，您偶然发现了",
    "The area nets you": "该区域给予你",
    "The location nets you": "这个位置给予你",
    "to be found.": "被发现。",
    "You search the vicinity and find": "你搜索附近，然后找到",
    "You uncovered a": "您发现了一个",
    "A careful investigate of the surroundings.": "对周围环境的仔细调查。",
    "Fast Travel Unlocked": "快速旅行已解锁",
    "Looking around the location to explore, you manage to uncover": "环顾此地以进行探索，你成功发现了",
    "Looking around the vicinity to scour, you manage to uncover": "环视周边区域进行搜寻，你也成功发现了",
    "Making sure to carefully explore the area. Your efforts pay off as you discover": "确保仔细探索该区域。你的努力得到了回报，因为你发现了",
    "Making sure to carefully scour the terrain. Your efforts pay off as you discover": "确保仔细搜查地形。你的努力也得到了回报，因为你发现了",
    "Runes, nice! are yours now, after scouring the vicinity.": "符文，太棒了！现在它们归你所有了，经过搜寻周边区域。",
    "Seems you will be traveling a lot between different areas, you make plans on how to get through explored regions faster.": "看来你将在不同的区域之间频繁移动，所以你制定了如何更快地通过已探索区域的计划。",
    "Something catches your eye. A": "有什么东西吸引了你的注意。一个",
    "The terrain nets you": "地形给予你",
    "The vicinity nets you": "周边环境给予你",
    "The vicinity yields": "周边环境有所助益",
    "You explore the area and find": "你探索这片区域并发现",
    "You retrieved a": "你找到了一个",
    "You scout the region and find": "你侦察该地区并发现",
    "You search the area and find": "你搜索这片区域并发现",
    "Traveling": "旅行前往",
    "to": "到",
    "The site yields": "现场产出",
    "A careful explore of the area.": "对该区域进行仔细的探索。",
    "after exploring the surroundings.": "在探索周边环境之后。",
    "after searching the location.": "在搜索该地点之后。",
    "As you investigate the surroundings, you come across": "当你仔细观察周围环境时，你发现了",
    "As you scavenge the location, you come across": "当你在该地点搜寻时，你发现了",
    "As you search the location, you come across": "当你在该地点仔细搜查时，你发现了",
    "from the surroundings.": "从周围环境。",
    "from the terrain.": "从地形。",
    "Looking around the site to scavenge, you manage to uncover": "环顾现场进行搜寻，你终于发现了",
    "Looking around the surroundings to investigate, you manage to uncover": "环顾周边环境进行调查，你终于发现了",
    "Looking around the surroundings to scour, you manage to uncover": "环顾周边环境进行仔细搜查，你终于发现了",
    "Looking around the vicinity to investigate, you manage to uncover": "环顾附近区域进行调查，你终于发现了",
    "Making sure to carefully scavenge the site. Your efforts pay off as you discover": "确保要仔细搜寻该地点。你的努力得到了回报，因为你发现了",
    "nothing of value": "没有任何有价值的东西",
    "Runes! are yours now, after exploring the surroundings.": "符文！经过对周边环境的探索，现在它们就是你的了。",
    "Taking time to investigate the terrain, you stumble upon": "花时间去调查地形，你偶然发现了",
    "Taking time to scout the location, you stumble upon": "花时间去侦察地点，你偶然发现了",
    "You scavenge the site and find": "你搜寻了该地点并找到了",
    "You scavenged": "你进行了搜寻",
    "You scout the site and find": "你侦察了该地点并找到了",
    "You search the terrain and find": "你调查了地形并找到了",
    "You uncovered": "你发现了",
    "from the area.": "从该区域。",
    ". Taken.": ". 拿走.",
    "after investigating the vicinity.": "在对该区域进行了调查之后。",
    "As you explore the surroundings, you come across": "当你探索周围环境时，你发现了",
    "As you investigate the vicinity, you come across": "当你仔细查看这个区域时，你发现了",
    "As you scour the area, you come across": "当你仔细搜查这个地点时，你发现了",
    "As you scour the location, you come across": "当你仔细勘察这个位置时，你发现了",
    "As you scout the region, you come across": "当你侦察这个地区时，你发现了",
    "Looking around the region to investigate, you manage to uncover": "环顾这个区域进行调查后，你终于发现了",
    "Looking around the site to explore, you manage to uncover": "环顾这个地点进行探索后，你终于发现了",
    "Runes, nice! are yours now, after scouring the region.": "符文，不错！现在它们归你所有了，因为你在该区域进行了仔细搜查。",
    "Taking time to investigate the vicinity, you stumble upon": "花时间调查这个区域后，你偶然发现了",
    "Taking time to scour the surroundings, you stumble upon": "花时间仔细查看周围环境后，你偶然发现了",
    "You safely extracted": "你安全地提取了",
    "You scavenge the surroundings and find": "你四处搜寻，然后找到了",
    "areas in": "区域在",
    "Click to fast travel": "点击以快速旅行",
    "After scouring the surroundings,": "在仔细查看周围环境之后，",
    "Runes! are yours now, after searching the surroundings.": "符文！搜索了一下周围，现在是你的了。",
    "A careful search of the terrain.": "对地形的仔细勘察。",
    "After searching the vicinity,": "在附近区域进行了搜索之后，",
    "Taking time to scavenge the area, you stumble upon": "花些时间仔细搜寻这个区域之后，你偶然发现",
    "The site nets you": "现场给予你",
    "After exploring the surroundings,": "在探索了周围环境之后，",
    "A careful scout of the site.": "对现场的仔细侦察。",
    "A careful search of the site.": "仔细搜索现场。",
    "after scavenging the location.": "在清除位置之后。",
    "Looking around the vicinity to search, you manage to uncover": "在附近四处寻找，你终于发现了",
    "Taking time to scour the region, you stumble upon": "花些时间仔细勘察这个区域，你就会偶然发现",
    "You investigate the terrain and find": "你对地形进行了勘察，并发现了",
    ", salvaged and stowed away.": "被抢救出来并妥善存放起来。",
    "After scouring the terrain,": "在仔细勘察了这片区域之后，",
    "You found a": "你发现了一个",
    "The surroundings yields": "周围的环境产生",
    "As you investigate the site, you come across": "当你对这个地点进行勘查时，你发现了",
    "You scavenge the region and find": "你搜寻这个区域，然后找到",
    "after scavenging the site.": "清理现场后。",
    "After scavenging the surroundings,": "在仔细搜寻了周围环境之后，",
    "after investigating the site.": "在调查了现场之后。",
    "After scavenging the vicinity,": "在清理了附近之后，",
    "from the region.": "从该地区。",
    "": "",
    "": "",
    "": "",
    "": "",
