...
var cnItems = {
    _OTHER_: [],
        ...
        'Continue':'继续',
        'Ashen Hand': '灰烬之手',
        'Increases Ash collection by': '灰烬收集量增加',
        'per click.': '',
        'Aura':'光环',
        ...
        'Base Name':'基地名称',
        'Establish Base':'建立基地',
        'Change the name of your base and home area on the map.':'在地图上更改你的基地和家园区域的名称。（不建议输入中文，经测试会出现存档无法导出的情况）',
        'Rename':'重新命名',
        'Saved!': '已保存！',
        ...
        'Your Name': '你的名号（不建议输入中文，经测试会出现存档无法导出的情况）',
        'Ashen One': '灰烬行者',
        ...
        'Reallocate': '重置加点',
        'Player Name': '玩家名称',
        'Change your character\'s name.': '更改你的角色名称。（不建议输入中文，经测试会出现存档无法导出的情况）',
